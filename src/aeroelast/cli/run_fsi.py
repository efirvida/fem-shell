...
Usage:
    python -m aeroelast.cli.run_fsi config.yaml [options]

Examples:
    # Run simulation from YAML
    python -m aeroelast.cli.run_fsi simulation.yaml

    # Run with custom working directory
    python -m aeroelast.cli.run_fsi simulation.yaml --workdir /path/to/case

    # Preview configuration without running
    python -m aeroelast.cli.run_fsi simulation.yaml --preview

    # Generate template configuration
    python -m aeroelast.cli.run_fsi --template > my_config.yaml
"""
