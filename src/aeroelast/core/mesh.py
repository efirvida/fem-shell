...
>>> from aeroelast.core.mesh.generators import SquareShapeMesh
>>> from aeroelast.core.mesh.io import write_mesh
"""

# Re-export everything from the mesh package for backward compatibility
from aeroelast.core.mesh import (  # Entities; Model; Generators; I/O
    ELEMENT_NODES_MAP,
    BladeMesh,
    BoxSurfaceMesh,
    ElementSet,
